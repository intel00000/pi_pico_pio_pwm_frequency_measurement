...
- <font color="yellow">**(NOTE)** I just realized the new version have a much lower max frequency range than the old version since the check status code block now take way more instruction cycle than the old version. Lesson here is to not push for a third register.</font>
